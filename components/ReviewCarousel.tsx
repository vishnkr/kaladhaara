...
const reviews: ShortTestimonials = [
    {
        ...
        imagePath: '/testimonials/Sadhana.jpg'
      },
    {
        ...
        imagePath: '/testimonials/Sathvika.jpg'
    },
    {
        ...
        imagePath: '/testimonials/Samyuktha_Suresh.jpg'
    },
    { name: "Gopika Srivastava",
      ...
      imagePath: '/testimonials/Gopika.jpg'
    },
    {
      ...
      imagePath: '/testimonials/Samyuktha_Rajkumar.jpeg'
    },
    {
      name: "Sahana Shankar",
      ...
      imagePath: '/testimonials/Sahana.jpg'
    },
    {
      ...
      imagePath: '/testimonials/Anika.jpg'
    },
    {
      name: "Diya Frank",
    ...
    return (
      <div className="w-full flex overflow-hidden">
        {reviews.map((review, index) => (
          <section
            key={index}
            className={`w-full bg-slate-100 rounded-md flex flex-col md:flex-row items-center ${
          ...
          >
            {review.imagePath && 
              <div className="p-4 flex items-center justify-center md:w-1/3">
                <img
            ...
            <div className="max-w-screen-sm py-3 px-4 mx-auto text-center lg:py-5">
