    ...
    return (
        <section className="isolate">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-center">ABOUT KALADHAARA</h1>
                ...
                <p className='mt-8 text-lg text-center leading-8 text-gray-600'>
                    Founded in 2011 by Artistic Director Mathura Viswanathan, Kaladhaara is today one of the premier classical arts institutes in the Greater Sacramento area. The academy nurtures every student’s individual talent, customizing lessons to their strengths and guiding them toward milestone performances such as pre-debut (salangai pooja), debut (arangetram) presentations and more. 
                    </p>
