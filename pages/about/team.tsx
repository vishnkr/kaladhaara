const staff = [
    ...
    },
    {
      ...
      description:
        ["I joined Kaladhaara at the age of 7 and my love for dance has grown ever since then. I am glad to have had so many oppurtunities to perform on stage such as Saptami fondation, where I won first prize and had the opportunity to dance with KCRA on TV. Through many years of experience in dance, I have completed my Salangai Poojai, in 2018, and successfully completed my Arangetram in 2023. I enjoy teaching kids, and at the same time going to Sac State."]
